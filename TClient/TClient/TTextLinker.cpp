...
CString CTTextLinker::MakeLinkToNetText( TEdit *pEdit, BOOL bLengthSafety, INT nMaxLength)
{
	...
	for( TComponent::TextSettingVector::iterator it = pEdit->GetTextSettingItrBegin(); it != pEdit->GetTextSettingItrEnd(); it++)
	{
...
{
	TComponent::TextSettingVector::iterator itr,end;
